...
from model.DDFormer import DDFormer
...
class Solver(object):
    ...
    def build_model(self):
        self.model = DDFormer(win_size=self.win_size, enc_in=self.input_c, c_out=self.output_c, n_heads=self.n_heads, d_model=self.d_model, e_layers=self.e_layers, patch_size=self.patch_size, channel=self.input_c)
